...
class ModelConfig(BaseConfig):
    ...
    block_type: Literal["TransformerBlock", "MambaBlock", "Mamba2Block", "Mamba2PoSTBlock", "RWKV7PoSTBlock", "RWKV7Block"] = "TransformerBlock"
    name: str = "default"
...
class TrainConfig(BaseConfig):
    ...
    lr_scheduler_type: Literal["cosine", "linear_decay"] = "cosine"
