...
class GatedLinearAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[Dict]
        ...
        # Use chunk mode always — installed fla's fused_recurrent_gla
        # doesn't support head_first kwarg needed for (B,T,H,D) layout.
        mode = self.mode
    ...
    def state_size(self, **kwargs) -> int:
        ...
        for module in self.children():
            if isinstance(module, ShortConvolution):
                state_size += sum(module.state_size) if isinstance(module.state_size, tuple) else module.state_size
        return state_size
